...
const Text = ({
  ...
  <div className='flex flex-col gap-3 border-b border-border px-5 py-3'>
    <h3 className='text-[10px] uppercase tracking-widest text-muted-foreground'>Text</h3>
...
const RenderSelect = ({
  ...
  >
    <SelectTrigger className='no-ring w-full rounded-sm border border-border text-foreground'>
      <SelectValue
        placeholder={
          config.property === "fontFamily"
            ? "Choose a font"
