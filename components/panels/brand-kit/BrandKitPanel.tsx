...
const BrandKitPanel = ({ fabricRef, shapeRef, syncShapeInStorage }: Props) => {
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex gap-2">
          <select
            ...
            className="flex-1 rounded-sm border border-border bg-background p-1.5 text-xs text-foreground"
          >
            {FONT_OPTIONS.map((f) => (
